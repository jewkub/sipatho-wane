<script lang="ts">
	...
	import { Form, Input, Label, Button, Col, Row, Collapse, Card, Container, Accordion } from 'sveltestrap';
	/**
	...
	function htmlToElement(html: string) {
		...
		return template.content.firstChild || template
	}
...
<svelte:head>
	<title>แลกเวร</title>
	<meta name="description" content="แลกเวร" />
</svelte:head>
...
<!-- <section>
	...
	<h2>
		hey, try editing <strong>src/routes/+page.svelte</strong>
	</h2>
